...
# ========================== SMART FLASK LAUNCH ==========================
LAST_FLASK_PORT = None  # Global variable to remember last port

def launch_flask_app(app_file: str):
    """
    1️⃣ Kill leftover Flask processes
    2️⃣ Ensure / route exists
    3️⃣ Ensure index.html exists
    4️⃣ Pick free port
    5️⃣ Launch Flask in background
    6️⃣ Print test URL for /hello
    """
...
def extract_json(text: str) -> dict:
    """
    Extract and auto-fix JSON from LLM response.
    Fully production-ready:
    - Handles incomplete JSON
    - Escapes multiline content safely
    - Returns Python dict
    """
    import json
    import re
    ...
    candidate = candidate.replace("\t", "    ")  # Replace tabs
